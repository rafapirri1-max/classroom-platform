  ...
  async function loadUserData() {
    ...
    if (session?.user) {
      ...
      const { data: enrollments } = await supabase
        ...
        .select('*, classes(class_name, class_code, teacher_id)')
        ...
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <a href="/login" className="text-sm bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition">
                Sign In
              </a>
            )}
          </div>
              ...
              <div className="bg-gray-700/50 rounded-lg p-4 mb-4">
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 bg-gray-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-green-500"
