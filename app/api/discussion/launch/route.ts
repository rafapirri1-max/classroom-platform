import { launchDiscussionActivity } from '@/lib/activity-instances'
import { validateDiscussionLaunchInput } from '@/lib/discussion/launch-config'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const activityInstanceId = await launchDiscussionActivity(supabase, room, validated.config)
